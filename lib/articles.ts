...
import remarkGfm from 'remark-gfm' // 导入 remark-gfm 插件，用于处理 GitHub 风格的 Markdown，包括脚注
import remarkAddTooltipData from './remark-add-tooltip-data.js' // 导入自定义的 remark 插件，用于将脚注定义的内容添加到脚注引用上
 ...
 */
export const getCategorizedArticles = (
    lang: string
...
export const getArticleData = async (
    ...
    const processedContent = await remark()
        .use(remarkGfm) // 使用 remark-gfm 插件处理 GitHub 风格的 Markdown
        .use(remarkAddTooltipData) // 使用自定义的 remark 插件，将脚注定义的内容添加到脚注引用上
