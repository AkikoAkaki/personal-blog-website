...
import { Cormorant_Garamond, Poppins, Noto_Sans_SC, Noto_Serif_SC } from "next/font/google"; // 导入字体，以优化性能并避免布局偏移。
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${cormorantGaramond.variable} ${poppins.variable} ${notoSansSC.variable} ${notoSerifSC.variable}`} // 将字体变量作为 className 应用，使其在 CSS 中可用。
