...
const HomePage = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  return (
    <>
      ...
      <section className="mx-auto mb-20 mt-20 flex w-11/12 flex-col gap-16 md:w-1/2">
        {/* 博客标题区域，使用 Tailwind CSS 工具类来定义字体、大小、字重和边距。 */}
        <header className="text-center font-cormorantGaramond text-neutral-900">
          <h1
        ...
        {/* 文章列表区域，在桌面端为两栏网格布局。 */}
        <section className="flex flex-col gap-10 md:grid md:grid-cols-2">
